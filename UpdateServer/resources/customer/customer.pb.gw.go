...
func request_Customer_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, client CustomerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterCustomerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CustomerClient) error {
	...
	mux.Handle("POST", pattern_Customer_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		fmt.Println("req")
		fmt.Println(req)
		...
		resp, md, err := request_Customer_SayHello_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Customer_SayHello_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Customer_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "hello"}, ""))
)

var (
	forward_Customer_SayHello_0 = runtime.ForwardResponseMessage
)
