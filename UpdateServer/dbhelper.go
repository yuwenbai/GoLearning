...
func InsertRecord(ApkName, VersionID, VersionName, VersionInfo string) bool {
	...
	if err != nil {
		glog.Fatal("GenerateConnectSQLDB failed:", err.Error())
	}
	//建立连接
	conn, err := sql.Open("mssql", connString)
	if err != nil {
		glog.Fatal("Open Connection failed:", err.Error())
	}
	defer conn.Close()
...
// 	var connString, err = GenerateConnectSQLDB()
// 	if err != nil {
// 		log.Fatal("GenerateConnectSQLDB failed:", err.Error())
// 	}
// 	//建立连接
// 	conn, err := sql.Open("mssql", connString)
// 	if err != nil {
